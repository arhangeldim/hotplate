...
public class DatabaseManager implements IDatabaseManager {
    ...
    @Override
    public Map<Integer, String> getAllRecipesName() {
        String[] columns = {"_id", "name"};
        Cursor cursor = db.query("recipes", columns, null, null, null, null, null);
        Log.d(LOG_TAG, "Cursor size: " + cursor.getCount());
        Map<Integer, String> recipes = new HashMap<Integer, String>();
        if (cursor.moveToFirst()) {
            int idColIndex = cursor.getColumnIndex("_id");
            int nameColIndex = cursor.getColumnIndex("name");
            do {
                recipes.put(cursor.getInt(idColIndex), cursor.getString(nameColIndex));
    ...
    @Override
    public Map<Integer, String> getRecipesName(Product ingridient) {
        // TODO Auto-generated method stub
        return null;
    }

    @Override
    public Map<Integer, String> getRecipesName(int categoryId) {
        // TODO Auto-generated method stub
        return null;
    }

    @Override
    public Map<Integer, String> getRecipesName(Product ingridient, int categoryId) {
        // TODO Auto-generated method stub
        return null;
    }

    @Override
    public List<Product> getProductsList(int type) {
        // TODO Auto-generated method stub
        return null;
    }
